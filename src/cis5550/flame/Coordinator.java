  ...
  public static void main(String args[]) {
    ...
    post("/submit", (request,response) -> {
      ...
      for (int i=0; i<getWorkers().size(); i++) {
        String entry = getWorkers().get(i);
        final String url = "http://"+entry.split(",")[1]+"/useJAR";
        final int j = i;
      ...
      FlameContextImpl context = new FlameContextImpl(kvs, args[1], jarName);
      ...
      String ret = context.outputString;
      if (ret.equals("")) {
        // TODO:
        ret = "";
      }
